...
// Menyimpan ke /public/uploads (dilayani statis). Di serverless (Vercel) FS
// read-only → gagal dengan aman dan balas [] agar pipeline lanjut memakai
// foto stok, bukan crash. Untuk produksi, ganti ke object storage (Vercel Blob/S3).

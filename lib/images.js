...
export function buildCoverSvg(listing) {
  ...
  const brand = esc(listing.brandName || "RumahPlus");
  const img = listing.images?.[0] || null; // tanpa foto → cover teks bermerek, bukan foto palsu
  ...
  <g clip-path="url(#round)">
    ${img ? `<image href="${img}" x="0" y="0" width="1200" height="1200" preserveAspectRatio="xMidYMid slice"/>` : `<rect x="0" y="0" width="1200" height="1200" fill="#214735"/>`}
  ...
  <g font-family="Georgia, 'Times New Roman', serif">
    ...
    <text x="1136" y="112" text-anchor="end" fill="#F7F4EE" font-size="34" font-weight="700">${brand}</text>
